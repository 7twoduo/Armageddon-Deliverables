...
resource "aws_lb_listener" "lab1c_bonusA_example_https_listener01" {
  ...
  certificate_arn   = aws_acm_certificate_validation.lab1c_bonusA_example_acm_validation01.certificate_arn
  ...
  depends_on = [aws_acm_certificate_validation.lab1c_bonusA_example_acm_validation01]
}
